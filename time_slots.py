...
class TimeSlotFactory(object):
    ...
    def _get_next_time_slot(self, end_time, duration, open_time, close_time) -> TimeSlot:
    ...
    def make_time_slot_sequence(self, start, days, duration, open_time, close_time, num_slots):
        ...
        while current_slot.end_time < doomsday:
            next_time = self._get_next_time_slot(current_slot.end_time, duration, open_time, close_time)
